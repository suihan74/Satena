...
import com.suihan74.satena.adapters.MaintenanceEntriesAdapter
...
class MaintenanceInformationFragment : CoroutineScopeFragment() {
    ...
    companion object {
        fun createInstance() = MaintenanceInformationFragment()
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        launch(Dispatchers.Main) {
            ...
            try {
                ...
                entriesList.adapter = MaintenanceEntriesAdapter(entries)
            }
            catch (e: Exception) {
