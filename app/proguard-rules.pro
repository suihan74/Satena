...
-keep class com.suihan74.satena.fragments.** { *; }
-keep class com.suihan74.satena.activities.** { *; }
-keep class com.suihan74.satena.adapters.** { *; }
-keep class com.suihan74.satena.models.** { *; }
